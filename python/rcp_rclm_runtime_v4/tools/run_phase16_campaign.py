...
def main() -> int:
    ...
    parser.add_argument("--challenge-stream", required=True)
    parser.add_argument("--target-promotions", type=int, required=True)
    ...
    report = run_phase16_campaign(
        bootstrap=bootstrap,
        source_head=args.source_head,
        source_tree=args.source_tree,
        seed=args.seed,
        challenge_stream=args.challenge_stream,
