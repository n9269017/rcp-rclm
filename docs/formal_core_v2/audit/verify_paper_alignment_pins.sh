...
require_text lean/rcp_rclm_formal_core_v2/RcpRclmFormalCoreV2/RCP/QuantumDensity.lean 'theorem DiagonalDensityMatrix.matrix_isHermitian'
require_text lean/rcp_rclm_formal_core_v2/RcpRclmFormalCoreV2/RCP/QuantumDensity.lean 'theorem DiagonalDensityMatrix.matrix_posSemidef'
require_text lean/rcp_rclm_formal_core_v2/RcpRclmFormalCoreV2/RCP/QuantumDensity.lean 'theorem DiagonalDensityMatrix.matrix_trace_one'
require_text lean/rcp_rclm_formal_core_v2/RcpRclmFormalCoreV2/RCP/QuantumDensity.lean 'theorem quantumRelativeEntropy_nonnegative'
require_text lean/rcp_rclm_formal_core_v2/RcpRclmFormalCoreV2/RCP/QuantumDensity.lean 'theorem source_target_quantumRelativeEntropy_pos'
require_text lean/rcp_rclm_formal_core_v2/RcpRclmFormalCoreV2/RCP/QuantumChannels.lean 'theorem selectedChannel_state_action'
require_text lean/rcp_rclm_formal_core_v2/RcpRclmFormalCoreV2/RCP/QuantumChannels.lean 'theorem selectedChannel_recovery_exact'
require_text lean/rcp_rclm_formal_core_v2/RcpRclmFormalCoreV2/RCP/QuantumChannels.lean 'theorem selectedChannel_quantumRelativeEntropy_preserving'
require_text lean/rcp_rclm_formal_core_v2/RcpRclmFormalCoreV2/RCP/QuantumKernel.lean 'theorem quantum_checker_refines_kernel'
require_text lean/rcp_rclm_formal_core_v2/RcpRclmFormalCoreV2/RCP/QuantumKernel.lean 'theorem quantumWorkedTrajectory_endpoint_recovery'
require_text lean/rcp_rclm_formal_core_v2/RcpRclmFormalCoreV2/RCP/QuantumKernel.lean 'theorem quantumWorkedTrajectory_first_step_strict'
require_text lean/rcp_rclm_formal_core_v2/RcpRclmFormalCoreV2/RCLM/QuantumBinary.lean 'theorem accepted_quantum_architecture_successor'
require_text lean/rcp_rclm_formal_core_v2/RcpRclmFormalCoreV2/RCLM/QuantumBinary.lean 'theorem improvement_quantum_architecture_successor'
require_text lean/rcp_rclm_formal_core_v2/RcpRclmFormalCoreV2/RCLM/QuantumBinary.lean 'theorem stability_quantum_architecture_successor'
require_text docs/formal_core_v2/audit/GateCAxiomAudit.lean '#print axioms RcpRclmFormalCoreV2.RCLM.QuantumBinary.accepted_quantum_architecture_successor'
...
require_text docs/formal_core_v2/GATE_C_SCOPE.md 'Selected finite-dimensional diagonal implementation: complete'
require_text docs/formal_core_v2/GATE_C_CLOSURE.md 'Gate C is complete at the declared finite-dimensional commuting/diagonal reference scope.'
require_text docs/formal_core_v2/EXIT_CRITERIA.md 'Gate C selected finite-dimensional diagonal reference: COMPLETE'
require_text docs/formal_core_v2/THEOREM_CONTRACT.md '## Selected Gate C density-matrix contract'

printf '%s\n' 'PASS: paper blobs, Gate A, Gate B, RCLM refinement, architecture engine, Paper II alignment, bounded seed-library, selected Gate C declarations, audits, and claim boundaries are pinned.'
